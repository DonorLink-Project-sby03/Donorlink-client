    ...
    <View style={{ backgroundColor: 'white', marginBottom: 5 }}>
      ...
      >
        <View style={{ display: 'flex', flexDirection: 'row', padding: 5 }}>
          <Image source={{ uri: 'https://upk.kemkes.go.id/new/imagex/content/182f78f3718c379655d2efd73f7efde3.png' }} style={{ backgroundColor: 'black', width: 50, height: 50, borderRadius: 50 }} />
